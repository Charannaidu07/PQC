...
def run_comparison_experiment():
    ...
    if not stats:
        ...
        stats = {
            ...
            "ML-DSA-44": {"keygen_ms": 0.4428, "memory_mb": 0.04, "signature_size": 2420, "security": 1.0, "energy": 1.5},
            "FN-DSA-512": {"keygen_ms": 29.4533, "memory_mb": 0.17, "signature_size": 662, "security": 1.0, "energy": 3.0}
        }
    else:
    ...
    print("\n====================================================")
    print("      PQC SUITE COMPARISON SIMULATION RESULTS")
    print("====================================================")
    print("\n--- KEM SELECTION COMPARISON (Averages across 100 Scenarios) ---\n")
    print("| Configuration | Decap Latency (ms) | Incremental RAM (MB) | Ciphertext Size (B) | Energy Cost | Security Level |")
    print("|---|---|---|---|---|---|")
    for cfg, m in summary["kem"].items():
        print(f"| {cfg:13s} | {m['latency_ms']:18.4f} | {m['memory_mb']:20.4f} | {m['bandwidth_bytes']:19.1f} | {m['energy_cost']:11.2f} | {m['security_level']:14.2f} |")

    print("\n--- SIGNATURE SELECTION COMPARISON (Averages across 100 Scenarios) ---\n")
    print("| Configuration | KeyGen Latency (ms) | Incremental RAM (MB) | Signature Size (B) | Energy Cost | Security Level |")
    print("|---|---|---|---|---|---|")
    for cfg, m in summary["sig"].items():
        print(f"| {cfg:13s} | {m['latency_ms']:19.4f} | {m['memory_mb']:20.4f} | {m['bandwidth_bytes']:18.1f} | {m['energy_cost']:11.2f} | {m['security_level']:14.2f} |")
    print("====================================================\n")
